    ...
    fun createItem(){
        ...
        when(itemTypeIndex){
            0->{
                ...
                if (createdItem.itemName=="Watykanczyk"){
            ...
            1->{
                ...
                equipment.add(createdItem);
                if (createdItem.itemName.contains("Kremowka")){
                    createdItem.maxItemDurability=2137;
                    createdItem.itemDurability=2137;
                }
                createdItem.showInfo();
            ...
            2->{
                ...
                equipment.add(createdItem);
                if (createdItem.itemName == "Papieska czapeczka"){
                    createdItem.maxItemDurability=2137;
                    createdItem.itemDurability=2137;
                }
                createdItem.showInfo();
            ...
            3->{
                ...
                equipment.add(createdItem);
                if (createdItem.itemName == "Sutanna"){
                    createdItem.maxItemDurability=2137;
                    createdItem.itemDurability=2137;
                }
                createdItem.showInfo();
            ...
            5->{
                ...
                equipment.add(createdItem);
                if (createdItem.itemName == "Rzulte rekawice"){
                    createdItem.maxItemDurability=2137;
                    createdItem.itemDurability=2137;
                }
                createdItem.showInfo();
            ...
            6->{
                ...
                equipment.add(createdItem);
                if (createdItem.itemName.contains("Papieskie pantalony")){
                    createdItem.maxItemDurability=2137;
                    createdItem.itemDurability=2137;
                }
                createdItem.showInfo();
            ...
            7->{
                ...
                equipment.add(createdItem);
                if (createdItem.itemName == "Blogoslawione mokasyny"){
                    createdItem.maxItemDurability=2137;
                    createdItem.itemDurability=2137;
                }
                createdItem.showInfo();
